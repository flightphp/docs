...
- [Single File Skeleton Boilerplate](https://github.com/flightphp/skeleton-simple): Un solo archivo que incluye todo lo que necesitas para ejecutar tu app en un archivo simple.
...
- [vite-flightphp](https://github.com/pauloramoscuba/vite-flightphp) - FlightPHP y frontend moderno (Vite + Tailwind CSS) con hot reload (recarga en caliente).
