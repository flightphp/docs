...
- **Zustandslos**: Keine serverseitige Sitzungsspeicherung erforderlich – perfekt für Microservices und APIs
...
- **RS256**, **RS384**, **RS512**: Verwendet Public/Private-Key-Paare
...
- Der Token wurde manipuliert
- Uhrzeitänderung zwischen Servern (fügen Sie einen Leeway-Puffer hinzu)
...
- `JWT::$leeway`: Statische Eigenschaft, um Zeit-Leeway für die Validierung festzulegen (in Sekunden)
...
- **Aktive Wartung**: Gepflegt vom Google/Firebase-Team
...
Die Firebase-JWT-Bibliothek ist unter der BSD 3-Clause License lizenziert. Details finden Sie im [Github-Repository](https://github.com/firebase/php-jwt).