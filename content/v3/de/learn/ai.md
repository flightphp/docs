...
Flight erleichtert es, Ihre PHP-Projekte mit KI-gestützten Tools und modernen Entwickler-Workflows aufzurüsten. Mit integrierten Befehlen zur Verbindung mit LLM-Anbietern (Large Language Model) und zur Generierung projektspezifischer KI-Coding-Anweisungen hilft Flight Ihnen und Ihrem Team, das Maximum aus KI-Assistenten wie GitHub Copilot, Cursor, Windsurf und Antigravity (Gemini) herauszuholen.

## Verständnis

KI-Coding-Assistenten sind am hilfreichsten, wenn sie den Kontext, die Konventionen und die Ziele Ihres Projekts verstehen. Die KI-Hilfen von Flight ermöglichen es Ihnen:
...
Zugangsdaten wurden in .runway-creds.json gespeichert
```
...
**Beispiel:**
```
Bitte beschreiben Sie, wofür Ihr Projekt gedacht ist? Meine tolle API
...
- Die KI-Hilfen sind so konzipiert, dass sie mit jedem LLM-Anbieter funktionieren, der OpenAI-kompatible APIs unterstützt.
