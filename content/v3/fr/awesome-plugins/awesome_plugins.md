...
- <span class="badge bg-primary">officiel</span> [flightphp/cache](/awesome-plugins/php-file-cache) - Classe de mise en cache légère, simple et autonome en fichier PHP
...
- [defuse/php-encryption](/awesome-plugins/php-encryption) - C'est une bibliothèque qui peut être utilisée pour chiffrer et déchiffrer les données. Se lancer est assez simple pour commencer à chiffrer et déchiffrer les données.
