...
- **Орієнтований на ШІ:** Мінімальне навантаження Flight та чиста архітектура роблять його ідеальним для інтеграції інструментів та API на основі ШІ. Чи будуєте ви розумних чат-ботів, панелі керування на основі ШІ, чи просто хочете експериментувати, Flight не заважає, дозволяючи зосередитися на важливому. [Шаблонний додаток](https://github.com/flightphp/skeleton) поставляється з попередньо налаштованими файлами інструкцій для основних асистентів кодування на основі ШІ з коробки! [Дізнайтеся більше про використання ШІ з Flight](/learn/ai)
...
Flight — один з найшвидших фреймворків PHP. Його легке ядро означає менше навантаження та більшу швидкість — ідеально для традиційних додатків та сучасних проектів на основі ШІ. Ви можете побачити всі бенчмарки на [TechEmpower](https://www.techempower.com/benchmarks/#section=data-r18&hw=ph&test=frameworks)
...
Цікаво, як він обробляє ШІ? [Дізнайтеся](/learn/ai), як Flight полегшує роботу з вашим улюбленим кодувальним LLM!
...
2. Допоможіть покращити документацію! Цей веб-сайт документації розміщено на [Github](https://github.com/flightphp/docs). Якщо ви помітили помилку або хочете покращити щось, не соромтеся надіслати pull request. Ми любимо оновлення та нові ідеї — особливо навколо ШІ та нових технологій!
