...
Відвідайте [репозиторій Github](https://github.com/firebase/php-jwt) для повної документації та деталей.
...
Для отримання додаткових деталей щодо middleware дивіться [документацію middleware](/learn/middleware).
...
- `JWT::urlsafeB64Encode(string $input)`: Безпечне для URL кодування Base64
- `JWT::urlsafeB64Decode(string $input)`: Безпечне для URL декодування Base64
...
- [Репозиторій Firebase JWT Github](https://github.com/firebase/php-jwt)
...
Бібліотека Firebase JWT ліцензована за BSD 3-Clause License. Дивіться [репозиторій Github](https://github.com/firebase/php-jwt) для деталей.